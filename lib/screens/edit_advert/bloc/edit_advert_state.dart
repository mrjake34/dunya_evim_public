...
class EditAdvertState extends Equatable {
  const EditAdvertState({
    this.model,
    this.status,
  ...
  final List<dynamic>? photosUrlList;
...
final class EditAdvertInitial extends EditAdvertState {}
